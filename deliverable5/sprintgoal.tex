...
\begin{figure}[]
    \centering
    \scalebox{.5}{\input{img/overview.tikz.tex}}
...
\begin{figure}
    \centering
    \scalebox{.5}{\input{img/packages.tikz.tex}}
...
\begin{figure}
    \centering
    \scalebox{.5}{\input{img/sequence.tikz.tex}}
...
\todo[inline]{Attach documentation as per Klaus' instructions. When they are given :)}
