...
% labels
    \draw   (0,1) node[anchor=east] {3}
            (0,2) node[anchor=east] {6}
            (0,3) node[anchor=east] {9}
            (0,4) node[anchor=east] {12}
            (0,5) node[anchor=east] {15}
            (0,6) node[anchor=east] {18}
            (0,7) node[anchor=east] {21};

% projected 
    \draw[thick, dotted, red] (0,7) -- (7,0);

% actual
    \draw[thick, blue] (0,7) -- (1,6.5) -- (2,6.0) -- (3,4) -- (4,3.5) -- (5,2.6) -- (6,2.6); 
